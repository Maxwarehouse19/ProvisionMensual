...
namespace ProvisionMensual
{
    ...
    private void ObtieneValorRegistroDetalleUPS(string[] valor,/*DataRow row, */ref PedidoUPS clsPedido)
        ...
        // obtiene el valor del registro de EJDDimensions
        // ----------------------------------------------
        private void ObtieneValorRegistroCancelados(DataRow row, ref ProvisionMensual.Clases.Cancelados clsPedido)
        {
        ...
        private void CargaCancelados(SqlConnection Conexion)
        {
            ...
            foreach (var Archivos in Directorios.GetFiles())
            {
                ...
                foreach (DataRow row in dataSet.Tables[0].Rows)
                {
                    ProvisionMensual.Clases.Cancelados clsPedido = new ProvisionMensual.Clases.Cancelados();
            ...
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        ...
                        worksheet.Cell(8, 1).SetValue(Etiqueta);
                        worksheet.Cell(8, 2).SetValue(Valor1);
                        ...
                        worksheet.Cell(9, 1).SetValue(Etiqueta2);
                        worksheet.Cell(9, 2).SetValue(Valor2);
                        ...
                        worksheet.Cell(10, 1).SetValue(Etiqueta4);
                        worksheet.Cell(10, 2).FormulaA1 = "=B22";
                        ...
                        worksheet.Cell(11, 1).SetValue(Etiqueta3);
                        worksheet.Cell(11, 2).SetValue(Valor3);

                        worksheet.Cell(12, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(12, 2).DataType = XLDataType.Number;

                        worksheet.Cell(12, 2).FormulaA1 = "=SUM(B3:B11)";
                    }
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        rango = worksheet.Range("D8:R8"); rango.Style.Fill.BackgroundColor = XLColor.Gray;
                        rango.Style.Font.FontSize = 12;

                        rango = worksheet.Range("D9:R9"); rango.Style.Fill.BackgroundColor = XLColor.PastelGray;
                        rango.Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        rango.DataType = XLDataType.Number;

                        rango = worksheet.Range("D10:R10"); rango.Style.Fill.BackgroundColor = XLColor.Silver;
                        rango.Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        rango.DataType = XLDataType.Number;
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        rango = worksheet.Range("A14:B14"); rango.Style.Fill.BackgroundColor = XLColor.MistyRose;
                        rango = worksheet.Range("A15:B15"); rango.Style.Fill.BackgroundColor = XLColor.Melon;
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        worksheet.Cell(14, 1).SetValue("Total Facturas Carriers");

                        Labels = "Gasto " + monthNombreProceso + " Venta " + monthNombreAnterior;
                        worksheet.Cell(15, 1).SetValue(Labels);

                        Labels = "TFC - Cobro de " + monthNombreAnterior;
                        worksheet.Cell(16, 1).SetValue(Labels);

                        Labels = "Gasto " + monthNombreProceso + " Venta " + monthNombreProceso;
                        worksheet.Cell(17, 1).SetValue(Labels);


                        rango = worksheet.Range("A20:B20"); rango.Style.Fill.BackgroundColor = XLColor.CadetGrey;
                        rango = worksheet.Range("A21:B21"); rango.Style.Fill.BackgroundColor = XLColor.PastelGray;
                        ...
                        worksheet.Cell(20, 1).SetValue(Labels);

                        Labels = "Shipping " + monthNombreProceso + " por cobrar ";
                        worksheet.Cell(21, 1).SetValue(Labels);
                        worksheet.Cell(22, 1).SetValue("Provision");


                        rango = worksheet.Range("A25:B25"); rango.Style.Fill.BackgroundColor = XLColor.PinkOrange;
                        rango = worksheet.Range("A26:B26"); rango.Style.Fill.BackgroundColor = XLColor.Sunset;

                        worksheet.Cell(25, 1).SetValue("Shipping No Cobrado Sales");
                        worksheet.Cell(26, 1).SetValue("Shipping No Cobrado");


                        rango = worksheet.Range("A29:B29"); rango.Style.Fill.BackgroundColor = XLColor.MikadoYellow;
                        rango = worksheet.Range("A29:B29"); rango.Style.Fill.BackgroundColor = XLColor.Jonquil;

                        worksheet.Cell(29, 1).SetValue("Shipping Cobrado");

                        Labels = "Total Shipping  " + monthNombreProceso;
                        worksheet.Cell(30, 1).SetValue(Labels);

                        worksheet.Cell(14, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(14, 2).DataType = XLDataType.Number;
                        worksheet.Cell(14, 2).FormulaA1 = "=SUM(B3:B9)";
                        ...
                        if (dt3.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(15, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(15, 2).DataType = XLDataType.Number;
                            worksheet.Cell(15, 2).InsertData(dt3);// inserta Contenido
                        }

                        worksheet.Cell(16, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(16, 2).DataType = XLDataType.Number;
                        worksheet.Cell(16, 2).FormulaA1 = "=B14-B15";
                        ...
                        if (dt4.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(17, 2).InsertData(dt4);// inserta Contenido
                        }
                    }
                    ...
                    worksheet.Cell(7, 19).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                    worksheet.Cell(7, 19).DataType = XLDataType.Number;
                    worksheet.Cell(7, 19).FormulaA1 = "=SUM(S3:S6)";

                    worksheet.Cell(7, 20).Style.NumberFormat.Format = "[$$-en-US] #,##0.000000";
                    worksheet.Cell(7, 20).DataType = XLDataType.Number;
                    worksheet.Cell(7, 20).FormulaA1 = "=(SUM(E3:I5)+R3)/S7";

                    worksheet.Cell(7, 21).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                    worksheet.Cell(7, 21).DataType = XLDataType.Number;
                    worksheet.Cell(7, 21).FormulaA1 = "=SUM(U3:U5)+SUM(B7:B9)";

                    worksheet.Cell(7, 22).Style.NumberFormat.Format = "[$$-en-US] #,##0.000000";
                    worksheet.Cell(7, 22).DataType = XLDataType.Number;
                    worksheet.Cell(7, 22).FormulaA1 = "=U7/S7";

                    if (comboBox2.Text != "SI")
                    {
                        worksheet.Cell(26, 3).Style.NumberFormat.Format = "[$$-en-US] #,##0.000000";
                        worksheet.Cell(26, 3).DataType = XLDataType.Number;
                        worksheet.Cell(26, 3).FormulaA1 = "=T7";
                        ...
                        worksheet.Cell(25, 2).FormulaA1 = "=I26";
                    }
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        ...
                        worksheet.Cell(26, 9).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(26, 9).DataType = XLDataType.Number;
                        worksheet.Cell(26, 9).FormulaA1 = "=E26-G26";
                        ...
                        foreach (DataRow row in dt6.Rows)
                        {
                            ...
                            {
                                worksheet.Cell(8, Fila).SetValue(column.ColumnName);
                                Fila = Fila + 1;
                            }
                            break;
                        }
                        ...
                        if (dt6.Rows.Count != 0)
                        {
                            worksheet.Cell(9, 4).InsertData(dt6);// inserta Contenido
                        }
                        ...
                        if (dt7.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(20, 2).InsertData(dt7);// inserta Contenido
                        }

                        worksheet.Cell(29, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(29, 2).DataType = XLDataType.Number;
                        worksheet.Cell(29, 2).FormulaA1 = "=B17+B20";

                        worksheet.Cell(30, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(30, 2).DataType = XLDataType.Number;
                        worksheet.Cell(30, 2).FormulaA1 = "=B26+B29";

                        worksheet.Cell(25, 3).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(25, 3).DataType = XLDataType.Number;
                        Labels = "100%";
                        worksheet.Cell(25, 3).SetValue(Labels);



                        worksheet.Cell(26, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(26, 2).DataType = XLDataType.Number;
                        worksheet.Cell(26, 2).FormulaA1 = "=(C26*B25)/C25";

                        worksheet.Cell(21, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(21, 2).DataType = XLDataType.Number;
                        worksheet.Cell(21, 2).FormulaA1 = "=B26";

                        worksheet.Cell(22, 2).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                        worksheet.Cell(22, 2).DataType = XLDataType.Number;
                        worksheet.Cell(22, 2).FormulaA1 = "=B20+B21";
                    }
                    ...
                    {
                        Labels = "Weekly Fees";
                        worksheet.Cell(8, 16).SetValue(Labels);
                        ...
                        if (dt20.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(9, 16).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(9, 16).DataType = XLDataType.Number;
                            worksheet.Cell(9, 16).InsertData(dt20);// inserta Contenido
                        }

                        Labels = "Replacements";
                        worksheet.Cell(8, 17).SetValue(Labels);
                        ...
                        if (dt21.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(9, 17).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(9, 17).DataType = XLDataType.Number;
                            worksheet.Cell(9, 17).InsertData(dt21);// inserta Contenido
                        }
                    }
                        Labels = "Replacements";
                    ...
                    {
                        Labels = "Shipware Sales";
                        worksheet.Cell(8, 18).SetValue(Labels);
                        worksheet.Cell(9, 18).FormulaA1 = "=((SUM(F9:Q9))*0.1685)*0.265";

                        Labels = "Freight";
                        worksheet.Cell(8, 11).SetValue(Labels);

                        Labels = "Returns";
                        worksheet.Cell(8, 12).SetValue(Labels);
                        ...
                        if (dt18.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(9, 12).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(9, 12).DataType = XLDataType.Number;
                            worksheet.Cell(9, 12).InsertData(dt18);// inserta Contenido
                        }


                        Labels = "Adjustments";
                        worksheet.Cell(8, 13).SetValue(Labels);

                        Labels = "Cancelled PO´s";
                        worksheet.Cell(8, 14).SetValue(Labels);
                        ...
                        if (dt19.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(9, 14).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(9, 14).DataType = XLDataType.Number;
                            worksheet.Cell(9, 14).InsertData(dt19);// inserta Contenido
                        }

                        Labels = "UPS Parcel";
                        worksheet.Cell(8, 15).SetValue(Labels);
                    }
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        rango = worksheet.Range("A34:D34"); rango.Style.Fill.BackgroundColor = XLColor.BlueGray;
                        rango = worksheet.Range("A35:D35"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A36:B36"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A37:B37"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A38:B38"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A39:B39"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A40:B40"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;

                        worksheet.Cell(34, 1).InsertData(titles8); //insert titles to one row
                    }
                    else
                    {
                        rango = worksheet.Range("A10:D10"); rango.Style.Fill.BackgroundColor = XLColor.BlueGray;
                        rango = worksheet.Range("A11:D11"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A12:B12"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A13:B13"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        ...
                        worksheet.Cell(10, 1).InsertData(titles8); //insert titles to one row
                    }
                    ...
                    if (dt39.Rows.Count != 0)
                    {
                        if (comboBox2.Text != "SI")
                        {
                            worksheet.Cell(35, 1).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(35, 1).DataType = XLDataType.Number;
                            worksheet.Cell(35, 1).InsertData(dt39);// inserta Contenido
                        }
                        else
                        {
                            worksheet.Cell(11, 1).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(11, 1).DataType = XLDataType.Number;
                            worksheet.Cell(11, 1).InsertData(dt39);// inserta Contenido
                        }
                    }
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        rango = worksheet.Range("A44:D44"); rango.Style.Fill.BackgroundColor = XLColor.BlueGray;
                        rango = worksheet.Range("A45:D45"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A46:B46"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A47:D47"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A48:B48"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A49:D49"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;


                        worksheet.Cell(44, 1).InsertData(titles10); //insert titles to one row
                    }
                    else 
                    {
                        rango = worksheet.Range("A22:D22"); rango.Style.Fill.BackgroundColor = XLColor.BlueGray;
                        rango = worksheet.Range("A23:D23"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A24:B24"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A25:D25"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;
                        rango = worksheet.Range("A26:B26"); rango.Style.Fill.BackgroundColor = XLColor.PowderBlue;
                        rango = worksheet.Range("A27:D27"); rango.Style.Fill.BackgroundColor = XLColor.AliceBlue;

                        worksheet.Cell(22, 1).InsertData(titles10); //insert titles to one row
                    }
                    ...
                    if (dt40.Rows.Count != 0)
                    {
                        if (comboBox2.Text != "SI")
                        {
                            worksheet.Cell(45, 1).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(45, 1).DataType = XLDataType.Number;
                            worksheet.Cell(45, 1).InsertData(dt40);// inserta Contenido
                        }
                        else
                        {
                            worksheet.Cell(23, 1).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(23, 1).DataType = XLDataType.Number;
                            worksheet.Cell(23, 1).InsertData(dt40);// inserta Contenido
                        }
                    }
                    ...
                    if (comboBox2.Text != "SI")
                    {
                        ...
                        if (dt38.Rows.Count != 0)
                        {
                            ...
                            worksheet.Cell(26, 9).Style.NumberFormat.Format = "[$$-en-US] #,##0.00";
                            worksheet.Cell(26, 9).DataType = XLDataType.Number;
                            worksheet.Cell(26, 9).InsertData(dt38);// inserta Contenido
                        }

                        worksheet.Cell(26, 7).SetValue(0);
                        worksheet.Cell(26, 8).SetValue(0);
                    }
                    ...
                    List<string[]> titlesFEDEX8 = new List<string[]> { new string[] { "ServiceType", "NetChargeAmount", "Accesorials", "FLatRate", "PromedioServicio", "Conteo", "AverageFlateRate", "AverageAccesorial", "EarnedDiscount", "PerformancePricing" } };
                    ...
                    if (dt61.Rows.Count != 0)
                    {
                        if (comboBox2.Text != "SI")
                        {
                            worksheet.Cell(53, 1).InsertData(dt61);// inserta Contenido
                        }
                        else
                        {
                            worksheet.Cell(32, 1).InsertData(dt61);// inserta Contenido
                        }
                    }
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    List<string[]> titlesFEDEX11 = new List<string[]> { new string[] { "Clasificacion", "Conteo", "sumEstimatedShiping", "sumMontoTotal" } };
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    List<string[]> titles = new List<string[]> { new string[] { "Sku", "Height", "Length", "Width", "ActualWeightAmount", "ZoneCode", "FulfillmentLocationName", "Clasificacion ", "NetchargeAmount" } };
